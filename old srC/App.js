    ...
    <>
      ...
      <div className="nav">
        <ul>
          ...
          <li className={location.pathname === "/" ? "" : "unselected"} onClick={() => navigate("/")}>
            <button>Home</button>
          </li>
          <li className={location.pathname === "/members" ? "" : "unselected"} onClick={() => navigate("/members")}>
            <button to="/members">Members</button>
          </li>
          <li className={location.pathname === "/contact" ? "" : "unselected"} onClick={() => navigate("/contact")}>
